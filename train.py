...
def main(args):
    ...
    if args.model_name == "dcrnn":
        model = graphConvulation_Classification(
        ...
        average_embeddings = np.load('avg_embeddings.npy')
        model = NeuroGNN_Classification(args, args.num_classes, device, dist_adj, average_embeddings, meta_node_indices=META_NODE_INDICES)
