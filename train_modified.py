...
def main(args):
    ...
    if args.model_name == "dcrnn":
        ...
        model = DCRNNModel_classification(args, args.num_classes, device, dist_adj, initial_sem_embs, meta_node_indices=META_NODE_INDICES)
